                                        ...
                                        <div class="card card-default">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div id="reservationdate" data-target-input="nearest">
                                                        <textarea name="etat" id="summernote" class="form-control" rows="4"></textarea>
                                            ...
                                            <div class="d-flex">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div id="reservationdate" data-target-input="nearest">
                                                        <textarea name="Remarque" id="summernote5" class="form-control" rows="4"></textarea>
                                            ...
                                            <div class="ml-4 mb-3">
                                                ...
                                                <a href="./sciences.php" class="btn btn-info">Ajouter</a>
                                            </div>
                                            </form>
